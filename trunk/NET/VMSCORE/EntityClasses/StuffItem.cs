...
namespace VMSCORE.EntityClasses
{
    ...
    public partial class StuffItem: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void FixupVolunteer(Volunteer previousValue)
        {
            ...
            if (previousValue != null && previousValue.StuffItems.Contains(this))
            {
                previousValue.StuffItems.Remove(this);
            }
    
            if (Volunteer != null)
            {
                if (!Volunteer.StuffItems.Contains(this))
                {
                    Volunteer.StuffItems.Add(this);
                }
